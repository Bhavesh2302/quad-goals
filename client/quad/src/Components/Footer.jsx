...
const Footer = () => {
  return (
    ...
    <Flex w={"78%"} m={"auto"} alignItems={"center"} justifyContent={"space-evenly"} fontSize={"16px"} color={"white"} pt={"30px"}>
        ...
        <Box w={"28%"} display={"flex"} flexDirection={"column"} pl={"0px"}  fontWeight={"500"} justifyContent={"flex-start"}m={"auto"}  h={"450px"} mt={"40px"} textAlign={"left"}>
              <Text color={"#808080"} mb={"18px"}>LEGAL</Text>
              ...
              <Text mb={"12px"}>Corporate - Foodie Money Codes Terms and Conditions</Text>
              <Text mb={"12px"}>Corporate - Foodie Discount Voucher Terms and Conditions</Text>
        </Box>
        <Box w={"16%"} display={"flex"} flexDirection={"column"} h={"450px"} pt={"20px"} gap={"20px"} pl={"0px"}  alignItems={"center"} justifyContent={"flex-start"} m={"auto"}>
              <Image src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_65/icon-AppStore_lg30tv"} alt={"appleStore"}/>
              <Image src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_65/icon-GooglePlay_1_zixjxl"} alt={"playStore"}/>
        </Box>
    </Flex>
    </Box>
  )
